...
INFLUXDB_TOKEN = "-k63cS-eDvhxT07xBq-_kTViJvSfVmwhy3FFrt0-j0feVUUzSFVWs15csBDlrjtYjK0IRb5f93C4446P94ao5w=="  # Replace with your InfluxDB token
INFLUXDB_ORG = "iotlab"      # Replace with your InfluxDB organization name
INFLUXDB_BUCKET = "dht11_data"  # InfluxDB bucket name

# MQTT setup
MQTT_BROKER = "192.168.43.82"  # ESP32's MQTT broker address
